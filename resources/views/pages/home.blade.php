    ...
    <nav class="navbar sticky-top shadow-sm navbar-expand-lg navbar-light py-2">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img class="img-fluid" src="{{asset('admin/assets/images/logo.png')}}" alt="" width="96px">
            </a>
            ...
            <div class="collapse navbar-collapse" id="header01">
                ...
                <div><a class="btn mt-3 bg-gradient-primary" href="{{url('/login')}}">Admin Login</a></div>
            </div>
        </div>
    </nav>
        ...
        <div class="container pt-2">
            <div class="row align-items-center mb-5">
                ...
                <div class="col-12 col-lg-6 offset-lg-1">
                    <img class="img-fluid" src="{{asset('admin/assets/images/hero.svg')}}" alt="">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-3 p-3">
                    <div class="card px-0 text-center">
                        <img class=" card-img-top mb-3 w-100" src="{{asset('admin/assets/images/man.jpg')}}" alt="">
                        <h5>Danny Bailey</h5>
        ...
        <div class="container text-center pb-5 border-bottom">
            ...
            <div>
                <a class="d-inline-block me-4" href="#">
                    <img src="{{asset('admin/assets/images/facebook.svg')}}">
                </a>
                <a class="d-inline-block me-4" href="#">
                    <img src="{{asset('admin/assets/images/twitter.svg')}}">
                </a>
                <a class="d-inline-block me-4" href="#">
                    <img src="{{asset('admin/assets/images/github.svg')}}">
                </a>
                <a class="d-inline-block me-4" href="#">
                    <img src="{{asset('admin/assets/images/instagram.svg')}}">
                </a>
                <a class="d-inline-block" href="#">
                    <img src="{{asset('admin/assets/images/linkedin.svg')}}">
                </a>
            </div>
        </div>
        <div class="mb-5"></div>
